...
def _write_frontend_env(env_local_path: Path, api_base: str) -> None:
    existing: dict[str, str] = {}
    if env_local_path.exists():
        for raw_line in env_local_path.read_text().splitlines():
            line = raw_line.strip()
    ...
    existing["NEXT_PUBLIC_API_BASE"] = api_base

    lines = [
        "# Auto-generated by start_tour.py — local overrides are preserved",
...
def _run_web_tour() -> None:
    ...
    _write_frontend_env(env_local_path, api_base)
