...
def _write_frontend_env(env_local_path: Path, api_base: str) -> None:
    ...
    existing["DEEPTUTOR_URL"] = api_base

    lines = [
        "# Auto-generated by start_web.py — local overrides are preserved",
...
def main() -> None:
    ...
    if not npm:
        log_error("npm not found. Run `python3 scripts/start_tour.py` first.")
        raise SystemExit(1)
    ...
    frontend_env["DEEPTUTOR_URL"] = api_base
