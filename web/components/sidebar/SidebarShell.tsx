...
export function SidebarShell({
  ...
  if (collapsed) {
    return (
      <aside className="group/sb relative flex h-screen w-16 shrink-0 flex-col items-center border-r border-[var(--border)] bg-[var(--bg-elev)]/88 py-3 backdrop-blur-[14px] transition-[width] duration-300 ease-[var(--ease-signature)]">
  ...
  return (
    <aside className="flex h-screen w-[248px] shrink-0 flex-col border-r border-[var(--border)] bg-[var(--bg-elev)]/88 backdrop-blur-[14px] transition-[width] duration-300 ease-[var(--ease-signature)]">
