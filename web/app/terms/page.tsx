  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-4xl flex-col gap-6 px-5 py-10 sm:px-8">
      ...
      <div className="rounded-[var(--radius)] border border-[var(--border)] bg-[var(--bg-elev)] p-6 text-sm leading-7 text-[var(--text-dim)]">
        <p>Use the service lawfully and do not attempt to abuse access limits, scrape other users’ data, or use the platform to process harmful or unauthorized content.</p>
        ...
        <p>Questions about these terms can be sent to support@tuto.app.</p>
      </div>
    </main>
  );
}
