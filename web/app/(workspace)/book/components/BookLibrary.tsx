...
const COVER_PALETTES: Array<{
  ...
  {
    base: "linear-gradient(135deg, #ffffff 0%, #eef6ff 58%, #829ab1 100%)",
    accent: "#102a43",
    spine: "rgba(16, 42, 67, 0.46)",
    glow: "rgba(130, 154, 177, 0.34)",
  },
  {
    base: "linear-gradient(135deg, #ffffff 0%, #f5fbf8 54%, #bcccdc 100%)",
    accent: "#243b53",
    spine: "rgba(16, 42, 67, 0.38)",
    glow: "rgba(188, 204, 220, 0.36)",
  },
  {
    base: "linear-gradient(135deg, #f8fcfa 0%, #d9e2ec 56%, #486581 100%)",
    accent: "#102a43",
    spine: "rgba(16, 42, 67, 0.42)",
    glow: "rgba(72, 101, 129, 0.28)",
  },
  {
    base: "linear-gradient(135deg, #eef6ff 0%, #bcccdc 55%, #627d98 100%)",
    accent: "#102a43",
    spine: "rgba(36, 59, 83, 0.55)",
    glow: "rgba(98, 125, 152, 0.32)",
  },
  {
    base: "linear-gradient(135deg, #ffffff 0%, #f5fbf8 55%, #9fb3c8 100%)",
    accent: "#102a43",
    spine: "rgba(16, 42, 67, 0.45)",
    glow: "rgba(159, 179, 200, 0.34)",
  },
  {
    base: "linear-gradient(135deg, #fbfffd 0%, #d9e2ec 56%, #486581 100%)",
    accent: "#243b53",
    spine: "rgba(16, 42, 67, 0.4)",
    glow: "rgba(72, 101, 129, 0.3)",
  },
];
