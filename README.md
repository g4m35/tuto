...
EMBEDDING_API_KEY=your-google-ai-studio-key
...
| `DEEPTUTOR_API_KEY`             | Web prod | Shared secret forwarded by the `web/` DeepTutor client; required for hosted web builds |
